...
| 項目 | 正確值 | 禁止使用 |
|------|--------|---------|
| 首頁 NAV 標語 | `在香氣中走出自己的旅程中` | 任何其他文字 |
| journey 分類顯示名稱 | `產區尋香` | `香旅`、`旅行`、`Journey` 單獨使用 |
...
| 文章 | 檔名 | 日期 | 分類 | 類型 |
|------|------|------|------|------|
| 慈悲的淚珠（岩玫瑰） | `cistus-labdanum.html` | 2024-06-01 | journey／產區尋香 | Premium |
...
| 版本 | 日期 | 變更 |
|------|------|------|
| v2.5 | 2026-04-05 | 首頁標語確定為「在香氣中找到生命的根本」、分類標籤統一使用「產區尋香」（禁用「香旅」）、新增岩玫瑰文章、date/written 雙欄位機制 |
